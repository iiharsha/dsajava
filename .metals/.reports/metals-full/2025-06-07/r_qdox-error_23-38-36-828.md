error id: file://<WORKSPACE>/src/main/java/com/neetcode/stack/MinStack.java
file://<WORKSPACE>/src/main/java/com/neetcode/stack/MinStack.java
...
```java
offset: 330
uri: file://<WORKSPACE>/src/main/java/com/neetcode/stack/MinStack.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/src/main/java/com/neetcode/stack/MinStack.java